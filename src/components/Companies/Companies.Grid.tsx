...
import GridFooter from '../MainGrid/MainGrid.Footer';
import ActionButton from '../MainGrid/MainGrid.ActionButton';
import GridToolbar from '../MainGrid/MainGrid.Toolbar';
import LoadingOverlay from '../MainGrid/MainGrid.LoadingOverlay';
...
export default function CompaniesGrid(props: CompaniesGridProps) {
    ...
    return (
        <>
            <GridToolbar onSearch={props.onSearch} />
            <DataGrid
                columns={columns}
                rows={props.rows}
